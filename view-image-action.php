...
//post comment
        ...
        $stmt = $db->prepare("INSERT INTO ba_comments (art_id, artist_id, user, comment, datePosted, isFlagged) VALUES(:art_id, :artist_id, :user, :comment, now(), :isFlagged)");
        $stmt->bindParam(':art_id', $art_id);
        $stmt->bindParam(':artist_id', $db_artist_id);
